  ...
  return (
    <div className="relative flex items-center justify-center w-64 h-64">
      ...
      <motion.div
        ...
        className={`absolute inset-0 rounded-full blur-3xl transition-colors duration-700 bg-brand`}
      />
      ...
      >
        <div className={`absolute inset-0 bg-gradient-to-br opacity-60 transition-all duration-700 from-brand-light to-brand`} />
